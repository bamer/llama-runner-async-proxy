...
class ErrorOutputDialog(QDialog):
    ...
    """
    def __init__(self, title: str, message: str, output_lines: List[str], parent: Optional['QDialog'] = None):
        ...
        if output_lines:
            ...
            expanding: Any = QSizePolicy.Policy.Expanding
            output_text_edit.setSizePolicy(expanding, expanding)

            layout.addWidget(QLabel("Last Output Lines:"))
            layout.addWidget(output_text_edit)

        ok_button: Any = QDialogButtonBox.StandardButton.Ok
