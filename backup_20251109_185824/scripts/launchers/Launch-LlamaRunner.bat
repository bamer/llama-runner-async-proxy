...
"%PYTHON_PATH%" "%MAIN_SCRIPT%" --config config/app_config.json --log-level INFO --lm-studio-port 1234 --ollama-port 11434
goto :end
...
"%PYTHON_PATH%" "%MAIN_SCRIPT%" --config config/app_config.json --log-level INFO --lm-studio-port 1234 --ollama-port 11434 --web-ui
goto :end
...
timeout /t 2 >nul
"%PYTHON_PATH%" "%MAIN_SCRIPT%" --config config/app_config.json --log-level INFO --lm-studio-port 1234 --ollama-port 11434 --web-ui --metrics-port 8585
...
"%PYTHON_PATH%" "%MAIN_SCRIPT%" --config config/app_config.json --log-level DEBUG --lm-studio-port 1234 --ollama-port 11434
goto :end
...
"%PYTHON_PATH%" "%MAIN_SCRIPT%" --config config/app_config.json --log-level INFO --lm-studio-port 1234 --ollama-port 11434 --headless
goto :end
