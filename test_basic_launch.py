#!/usr/bin/env python3
"""
Simple test to verify basic functionality without GUI dependencies.
"""
import sys
import os
sys.path.insert(0, '.')
...
# Test faster whisper runner
try:
    from llama_runner.faster_whisper_runner import FasterWhisperRunner
    print("FasterWhisperRunner imported successfully")
except Exception as e:
    print(f"FasterWhisperRunner failed: {e}")
    sys.exit(1)

print("\nAll core modules imported successfully!")
print("The refactoring appears to be functionally correct.")