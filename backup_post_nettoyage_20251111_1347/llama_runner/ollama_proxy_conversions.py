...
def embeddingRequestFromOllama(ollama_req: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def embeddingResponseToOllama(openai_resp: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def generateRequestFromOllama(ollama_req: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def generateResponseToOllama(openai_resp: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def chatRequestFromOllama(ollama_req: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def chatResponseToOllama(openai_resp: Dict[str, Any]) -> Dict[str, Any]:
    """
